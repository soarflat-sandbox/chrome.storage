...
exports.default = new _vuex2.default.Store({
  ...
  actions: {
    setItems: function setItems(_ref4, items) {
    ...
    removeItem: function removeItem(_ref5, item) {
    ...
    searchItems: function searchItems(_ref6, keywords) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_1e20208e_hasScoped_true_node_modules_vue_loader_lib_selector_type_template_index_0_Histories_vue__ = __webpack_require__(31);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
